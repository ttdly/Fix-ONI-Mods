...
{
    class ConduitPressureSensorLiquid : IBuildingConfig
    {
        public const string ID = "Nightinggale.ConduitPressureSensorLiquid";
        ...
        public static LocString LOGIC_PORT = "Internal " + UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID") + " Pressure";
